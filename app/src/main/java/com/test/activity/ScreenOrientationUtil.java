...
public class ScreenOrientationUtil {
	...
	private boolean focusForbidOrientation = false;
	
	private boolean isFocusOrientation = false;
...
//	            }
	            ...
	            if (isFocusOrientation) {
	            	isFocusOrientation = false;
	            	mOrientation = mOrientation1;
	            }
	...
	public void setFocusForbidOrientation(boolean focusForbidOrientation) {
		this.focusForbidOrientation = focusForbidOrientation;
	...
	public boolean isFocusForbidOrientation() {
		return focusForbidOrientation;
	}
}
