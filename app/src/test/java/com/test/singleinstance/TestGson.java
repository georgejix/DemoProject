...
public class TestGson {
	...
	private void t1() {
		...
		Gson gson = new Gson();
		GetDeviceBaseInfoData j = gson.fromJson(s, GetDeviceBaseInfoData.class);
		...
		Gson gson = new Gson();
		GetDeviceWorkingConditionData j = gson.fromJson(s, GetDeviceWorkingConditionData.class);
		GetDeviceWorkingConditionData.Detail d = j.getWorkTime().getDetail().get(0);
	...
	private void t2() {
		Gson gson = new Gson();
		Type dataListType = new TypeToken<ArrayList<A>>() {}.getType();
		System.out.println(dataListType.toString());
        List<A> dataList = gson.fromJson("[\"513-3-4\",\"1541-7-8\",\"4105-17-18\",\"78385-19-52\",\"79413-23-65\",\"148290-4-69\",\"149318-1-66\",\"148547-5-70\",\"147783-2-67\",\"148804-6-71\",\"148033-3-68\",\"149061-7-65\",\"143930-1-127\",\"\"]", dataListType);
